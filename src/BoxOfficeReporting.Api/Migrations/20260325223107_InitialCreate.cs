        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ReportEntryId = table.Column<int>(type: "INTEGER", nullable: false),
                    EventName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    DeductionPercent = table.Column<decimal>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReportEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReportEvents_ReportEntries_ReportEntryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportEntries_UserId",
                table: "ReportEntries",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ReportEvents_ReportEntryId",
                table: "ReportEvents",
